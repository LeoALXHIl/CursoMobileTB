...
class _ProdutoPageState extends State<ProdutoPage>{
  ...
  void _carregarProdutos() async{
    ...
    try {
      ...
      setState(() {
        // corrigir caso a decodificação fique errada (fazer o cast da lista)
  ...
  //metodo para adicionar produto na lista de produtos
  void _adicionarProduto() {
    ...
    setState(() {
      produtos.add(produto); // adiciona o produto dentro do vetor
      _nomeProdutoController.clear(); // limpa o campo de nome
      _valorProdutoController.clear(); //na mão
  ...
  void _removerProduto(int index) {
    ...
    _salvarProdutos(); // salva a lista atualizada
  }
