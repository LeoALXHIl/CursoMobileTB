...
class _TarefasPageState extends State<TarefasPage>{
  ...
  //endreço da Api (json-server do computador)
  final String baseurl = 'http://10.109.197.21:3001/tarefas';
  ...
  void _carregarTarefas() async{
    try {
      ...
      //fazendo uma solicitação do tipo get para o endereço da api (converter string para url)
      final response = await http.get(Uri.parse(baseurl));
      if (response.statusCode == 200) {
        //decodficando para o map
